...
const ABOUT_IMAGE =
  "https://lh3.googleusercontent.com/gps-cs-s/APNQkAHXTQ4K7Sy_DpvcLUwN3epuRhv44BCkIxz0HlFKVqpJNKdFuGYvQqGFDc2lPh1qAi7ssJETOSmh82HqPUbEJ7VzkUTO8FW30NfiaaD2TuXUbu1WQMJ4pnlEqtMyLnV3wqQl2_W_Lj0J7YQ=s680-w680-h510";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div>
            ...
            <h2
              className="font-heading text-4xl sm:text-5xl text-[#2D2A26] font-semibold leading-tight mb-4"
              data-testid="about-title"
            >
              {tr.title}
            </h2>
            <p className="text-base text-[#5C5852] mb-2 font-body italic">
              {tr.subtitle}
            </p>
            <div className="w-12 h-0.5 bg-[#BA4A2B] mb-6 mt-4" />
            <p className="text-base text-[#5C5852] leading-relaxed mb-4">
              {tr.text1}
            </p>
            <p className="text-base text-[#5C5852] leading-relaxed mb-8">
              {tr.text2}
            </p>
          ...
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden">
              <img
                src={ABOUT_IMAGE}
                alt={
                  lang === "pl" ? "Wnętrze restauracji" : "Restaurant interior"
                }
            ...
            <div className="absolute -bottom-6 -left-6 hidden md:block bg-[#BA4A2B] text-white p-6 w-36">
              ...
              <p className="text-xs uppercase tracking-wider mt-1 text-white/80">
                {lang === "pl" ? "ocena" : "rating"}
              </p>
              <p className="text-xs text-white/60 mt-0.5">
                193 {lang === "pl" ? "opinii" : "reviews"}
              </p>
            </div>
          </div>
        </div>
        ...
        >
          {tr.stats.map((stat, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-[#F2EFE9] border border-[#D5D1C8] p-6 text-center"
                data-testid={`stat-${i}`}
              >
                <Icon
                  size={20}
                  className="text-[#BA4A2B] mx-auto mb-3"
                  strokeWidth={1.5}
                />
                <p className="font-heading text-2xl font-semibold text-[#2D2A26] leading-none">
                  {stat.value}
                </p>
                <p className="text-xs uppercase tracking-widest text-[#5C5852] mt-2">
                  {stat.label}
                </p>
